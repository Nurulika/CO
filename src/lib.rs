...
#[derive(Debug)]
pub struct CORSConfigProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CORSConfigProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CORSConfig processing");
    
    let mut processor = CORSConfigProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CORSConfigProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CORSConfigProcessor::new(false);
